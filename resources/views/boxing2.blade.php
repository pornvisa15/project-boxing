        ...
        <div class="white-space">
            ...
            <div class="content-container">
                ...
                <div class="text-container3">
                    ...
                    <p>หมัดเสยเป็นหมัดที่โจมตีจากล่างขึ้นบน โดยมักเล็งไปที่คางหรือปลายคางของคู่ต่อสู้
                        เพื่อสร้างแรงกระแทกที่รุนแรงและทำให้เสียสมดุลหรือหมดสติได้ทันทีหากถูกจุด</p>
                </div>
            </div>
            ...
            <div class="content-container">
                ...
                <div class="text-container">
                    ...
                    <p>การกำหมัดให้แน่น งอข้อศอก หงายหมัด และปล่อยหมัดจากล่างพุ่งขึ้นในวิถีตั้ง ทำมุมฉากกับพื้น
                        โดยมีสองแบบคือ หมัดเสยนำและหมัดเสยตาม</p>
                    <p>หมัดเสยนำ จะใช้ได้ดีเมื่อเป้าหมายอยู่ใกล้ตัวการเข้าคลุกวงในแล้วคู่ต่อสู้ก้มต่ำเป้าหมายที่ชก คือ
                        บริเวณคาง ท้อง หน้าอกท่าหมัดเสยนำเป็นการปล่อยหมัดจากตำแหน่งเตรียม
                        ใช้ในการเปิดเกมหรือเบิกทางเพื่อสร้างโอกาสโจมตี</p>
                    <p>หมัดตามเป็นการปล่อยหมัดจากข้างที่อยู่ห่างกว่า
                        โดยหมัดตามนี้จะมีแรงและน้ำหนักมากกว่าเนื่องจากได้แรงบิดจากสะโพกและไหล่
                        หมัดเสยทั้งสองแบบนี้มีประสิทธิภาพในการโจมตีระยะใกล้ โดยเฉพาะเมื่อคู่ต่อสู้ก้มตัวลงหรือลดการ์ด
                    </p>
                    <h3>ใช้สำหรับ</h3>
                    ...
                    <h3>ความรุนแรง</h3>
                    <p>โดยเฉลี่ยแล้วแรงหมัดของนักมวยมืออาชีพสามารถทำได้ประมาณ 300–600 กิโลกรัมต่อแรงกระแทก หรือประมาณ
                        650–1,300 ปอนด์ขึ้นไป</p>
                </div>
            </div>
