        ...
        <div class="white-space">
            ...
            <div class="content-container">
                ...
                <div class="text-container3">
                    ...
                    <p>เป็นเทคนิคที่ใช้เข่าพุ่งไปในมุมเฉียง โดยมักโจมตีที่ลำตัวด้านข้างหรือใบหน้าของคู่ต่อสู้
                        เทคนิคนี้ใช้แรงจากการหมุนสะโพกและการดึงตัวคู่ต่อสู้เพื่อเพิ่มพลัง
                        หมัดจะมีประสิทธิภาพในการสร้างความเสียหายและทำให้คู่ต่อสู้เสียสมดุล</p>
                </div>
            </div>
            ...
            <div class="content-container">
                ...
                <div class="text-container">
                    <h3>เข่าเฉียง</h3>
                    <p>ข่าเฉียงคือการตีเข่าที่มีวิถีการตีเฉียงขึ้นจากจุดตั้งต้นของเข่าไปยังตำแหน่งที่เข่าปะทะเป้าหมาย
                        ถ้าตีเข่าซ้าย จะเฉียงมากระทบเป้าด้านขวา ตีเข่าขวาจะเฉียงมากระทบเป้าด้านซ้าย ถ้าคู่ชกเข้ามาตรง ๆ
                        เข่าเฉียงจะถูกเป้าที่โคนขาและลำตัวด้านข้าง</p>
                    <p>มีวิธีการตีเข่าคล้าย ๆ กับเข่าตรงแต่แตกต่างตรงที่ทิศทางของเข่าไม่ได้พุ่งขึ้นมาในแนวดิ่ง
                        และเรามักจะเบี่ยงตัวเมื่อตีเข่า หรือหลบฉากออกซ้ายขวาของคู่ฉกแล้วตีเข่าเฉียงเข้าใส่
                        ถ้าหลบออกขวาให้ตีเข่าซ้ายหลบออกซ้ายให้ตีเข่าขวา เก็บคางให้มิดชิด มือปิดข้าง ใบหน้าและท้อง
                        ให้รัดกุมการตีเข่าเฉียงจะใช้ได้ดีในโอกาสที่คู่ชกถลำเข้ามาให้ถอยออกห่าง หลบฉาก กอดปล้ำ เกาะ
                        เหวี่ยง ผลักฉุก กระชากแล้วจึงตีเข่า เป้าหมายที่ท้องหรือหน้าอก
                        จะหยุดการเข้าทำของคู่ชกและสร้างความได้เปรียบทันที</p>
                    <h3>ใช้สำหรับ</h3>
                    <p>การโจมตีจากด้านล่างขึ้นไปยังใบหน้า คาง
                        หรือปลายคางของคู่ต่อสู้มักใช้เมื่อคู่ต่อสู้อยู่ใกล้หรือกำลังโน้มตัว
                        ท่านี้ใช้แรงบิดจากสะโพกและไหล่เพื่อเพิ่มพลังโจมตีจากล่างขึ้นบน
                        การโจมตีที่บริเวณล่างของคางหรือใบหน้าอาจทำให้คู่ต่อสู้อาจหมดสติได้
                        เหมาะสำหรับระยะประชิดและการจู่โจมใต้การ์ดของคู่ต่อสู้ ควรระวังไม่ให้เปิดการ์ดมากเกินไป
                        เพราะอาจถูกสวนกลับได้</p>

                    <h3>ความรุนแรง</h3>
                    <p>เข่าของนักมวยมืออาชีพสามารถสร้างแรงกระแทกได้ประมาณ 1,000–1,500 ปอนด์ต่อตารางนิ้ว (PSI)
                        ขึ้นอยู่กับน้ำหนักและทักษะของนักมวย รวมถึงเทคนิคในการใช้เข่า
                        โดยแรงของเข่ามักมีผลมากในกีฬามวยไทยหรือศิลปะการต่อสู้อื่น ๆ ที่เน้นการใช้เข่าในการโจมตี</p>
                </div>
            </div>
