    ...
    <section class="white-box">
        <div class="box-item">
            ...
            <div>
                ...
                <h4>ผลงาน</h4>
                <p> เป็นหัวหน้าค่ายและเทรนเนอร์ มาตั้งแต่ตอนเปิดค่าย มาคนเดียวเด็กได้เเชมป์หลาย
                    ชมรมและสมาคมภาคใต้อย่างต่อเนื่อง ต่อมายักมวยเริ่มมากขึ้น ต้องเพิ่มเทรนเนอร์ขึ้นมาอีก</p>
            </div>
        </div>
    </section>
    <section class="white-box">
        <div class="box-item">
            ...
            <div>
                ...
                <h4>ผลงาน</h4>
                <p>ช่วยกันเทรนนักมวยทุกคนสลับสับเปลี่ยนกันตามกำลัง
                    จนมีแชมป์แห่งประเทศไทยและแชมป์เวทีมาตรฐานสยาอ้อมน้อยพร้อมกันทั้ง 2 เส้น</p>
            </div>
        </div>
    </section>
    <section class="white-box">
        <div class="box-item">
            ...
            <div>
                ...
                <h4>ผลงาน</h4>
                <p>เป็นเทรนเนอร์ ผ่านการอบรม C-Line sean ช่วยสอนและดูแลนักมวยตามกฏกติกาของค่าย
                    และต้องออกอบรมเพิ่มเติมเกี่ยวกับ พรบ.มวย</p>
            </div>
        </div>
    </section>
