        ...
        <div class="white-space">
            ...
            <div class="content-container">
                ...
                <div class="text-container3">
                    ...
                    <p>เป็นเทคนิคที่ใช้ศอกในการโจมตีจากล่างขึ้นบน
                        โดยจะงัดศอกขึ้นในมุมเฉียงหรือแนวตั้งเพื่อตีคู่ต่อสู้ที่คางหรือใบหน้า
                        เทคนิคนี้ใช้แรงจากการหมุนของร่างกายและสะโพกเพื่อเพิ่มพลังการโจมตี
                        สามารถสร้างความเสียหายได้มากและทำให้คู่ต่อสู้เสียสมดุลหรือล้มลง</p>
                </div>
            </div>
            ...
            <div class="content-container">
                ...
                <div class="text-container">
                    <h3>ศอกงัด</h3>
                    <p>คือ เป็นศอกที่ใช้ตีเสยขึ้นโดยการงัดขึ้นตรงๆ
                        หรือบางครั้งอาจเฉียงเล็กน้อยการงัดให้ย่อตัวลงเพื่อที่จะใช้แรงส่งจากเท้า
                        ใช้เมื่อคู่ต่อสู้จะเข้ามาจับคอตีเข่าให้ใช้ศอกงัดเข้าที่เป้าหมาย คือ ปลายคางของ คู่ต่อสู้</p>
                    <p>ผู้โจมตีจะงอข้อศอกประมาณ 90 องศา และยกแขนขึ้นมาจากด้านล่าง
                        การงัดศอกจะเริ่มจากการงอเข่าเล็กน้อยแล้วดันขึ้น ส่งแรงจากขาไปยังลำตัวและศอก
                        เคลื่อนไหวเป็นการงัดศอกขึ้นจากด้านล่างเป้าหมายไปยังส่วนที่อ่อนแอของคู่ต่อสู้ เช่น ใต้คางหรือกราม
                        ควรมีการควบคุมสมดุลของร่างกายและการป้องกันที่ดี เพื่อป้องกันการโต้ตอบจากคู่ต่อสู้</p>
                    <h3>ใช้สำหรับ</h3>
                    <p>ใช้โจมตีที่คางหรือใบหน้าเพื่อทำให้คู่ต่อสู้เสียสมดุลและหมดสติได้
                        หรืออาจใช้โจมตีที่ลิ้นปี่เพื่อทำให้หายใจลำบากและสร้างความเจ็บปวด</p>

                    <h3>ความรุนแรง</h3>
                    <p>ศอกของนักมวยมืออาชีพสามารถสร้างแรงกระแทกได้ประมาณ 1,000–2,000 ปอนด์ต่อตารางนิ้ว (PSI)
                        ขึ้นอยู่กับเทคนิคและน้ำหนักตัวของนักมวย
                        ศอกที่มีแรงกระแทกสูงสามารถทำให้คู่ต่อสู้เจ็บหนักหรือหมดสติได้</p>
                </div>
            </div>
