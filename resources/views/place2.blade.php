        ...
        <div class="white-space">
            ...
            <div class="content-container">
                ...
                <div class="text-container">
                    <h3>ประกอบไปด้วย</h3>
                    <p>มีเวทีมวย ลู่วิ่งไฟฟ้า กระสอบทราย และการแนะนำนักมวยภายในค่าย โดยเวทีมวยหรือสังเวียนมวย (Boxing
                        Ring) ใช้สำหรับการแข่งขันชกมวย โดยมีลักษณะเป็นรูปสี่เหลี่ยมจัตุรัส ล้อมรอบด้วยเชือก 4 เส้น
                        ซึ่งเชือกแต่ละเส้นต้องมีขนาดเส้นผ่านศูนย์กลางไม่น้อยกว่า 1.5 นิ้ว
                        พื้นสนามต้องมีความปลอดภัยและปราศจากสิ่งกีดขวาง สำหรับทางขึ้นเวทีจะมีบันได 3 ทาง
                        โดยมีความกว้างไม่น้อยกว่า 3 ฟุต โดยบันได 2
                        ทางจะอยู่ที่มุมตรงข้ามของเวทีสำหรับให้นักมวยและพี่เลี้ยงใช้ขึ้นลง
                        ส่วนบันไดอีกหนึ่งทางจะตั้งอยู่ที่มุมกลางสำหรับผู้ชี้ขาดและแพทย์</p>
                    <h3>ทางด้านซ้าย</h3>
                    <p>มีลู่วิ่งไฟฟ้าเพื่อให้นักมวยหรือผู้ที่สนใจได้ใช้ออกกำลังกายและวอร์มกล้ามเนื้อก่อนเริ่มเรียนชกมวย
                    </p>
                    <h3>ทางด้านขวา </h3>
                    <p>มีกระสอบทราย ซึ่งเป็นอุปกรณ์ที่ใช้สำหรับการฝึกซ้อมมวย กระสอบทรายนี้สามารถใช้ฝึกการต่อย เตะ
                        และฝึกท่าทางต่าง ๆ ที่เกี่ยวข้องกับมวย ซึ่งจะช่วยเสริมสร้างความแข็งแรงของกล้ามเนื้อผู้ฝึก
                        รวมถึงเพิ่มศักยภาพและพัฒนาทักษะการเตะและต่อยของนักมวย</p>
                </div>
            ...
            <div class="content-container1">
                ...
                <a href="https://www.jaroenthongmuaythairatchada.com/blog/read/216?fbclid=IwY2xjawFUuIFleHRuA2FlbQIxMAABHVa68QoxbU8Sapak6qyK0Y3aDUME4__HpObPsudgZq7XnSF6lGpyRSbOTQ_aem_wqGqAgWpGOSEprvgehQyow"
                    class="video-link">
