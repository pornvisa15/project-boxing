...
<head>
    ...
    <title>คอร์สมวยไทยป้องกันตัว</title>
...
<body>
    ...
    <section class="hero">
        ...
        <div class="container">
            <div class="hero-con">
                <div class="hero-info">
                    <h3>โปรแกรมสร้างสมรรถภาพและพละกำลัง</h3>
                </div>
            </div>
        </div>
    </section>
    ...
    <section class="white-box">
        <div class="box-item">
            <div class=" box">
                ...
                <h4>มวยไทยสำหรับการลดน้ำหนัก</h4>
            </div>
            <div class="content">
                {{-- <h4>มวยไทยสากล (Muay Thai Boxing)</h4> --}}
                <h4>ระยะเวลาเรียน</h4>
                <p> 1 ชั่วโมง 30 นาที</p>
                <h4>รายละเอียด</h4>
                <p>- มุ่งเน้นการเสริมสร้างสมรรถภาพร่างกายและความแข็งแรงด้วยการฝึกท่ามวยไทย</p>
                <p>- ฝึกท่าโจมตีที่ใช้ความเร็วและพลังสูง</p>
                <p>- การฝึกจะรวมการยืดหยุ่นร่างกายและการฝึกกำลังเพื่อเพิ่มพละกำลังและความทนทาน</p>
                <p>- เหมาะสำหรับการฝึกเต็มร่างกาย สร้างกล้ามเนื้อแขน ขา และลำตัว</p>
                <p>- ช่วยลดน้ำหนักและขจัดไขมันอย่างมีประสิทธิภาพ</p>
                <h4>ราคา</h4>
                <p> 15,000 บาท </p>
                <h4>ผู้สอน</h4>
