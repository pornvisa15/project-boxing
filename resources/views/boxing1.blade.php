...
<section class="white-box">
    ...
    <div class="content-container">
            ...
            <div class="text-container3">
                <h3>หมัดมวยไทย</h3>
                <p>หมัดเป็นอาวุธสำคัญในมวยไทย (Muay Thai) ที่ใช้บ่อยในการต่อสู้ นักมวยใช้หมัดไม่เพียงเพื่อโจมตี แต่ยังมีหลากหลายรูปแบบและทิศทางเพื่อเพิ่มความหลากหลายและเทคนิคในการชก การฝึกฝนเทคนิคหมัดอย่างถูกต้องจะช่วยเพิ่มประสิทธิภาพในการแข่งขันและทำให้การต่อสู้มีความน่าสนใจมากขึ้น</p>
            </div>
    </div>
    ...
    <div class="content-container">
            ...
            <div class="text-container">
                ...
                <p>หมัดตรงชกนำหรือหมัดตรงหน้า การถ่ายน้ำหนักตัวจากเท้าหลังมายังเท้าหน้า ส่งแรงไปยังลำตัวถึงหัวไหล่ ไปยังหมัดหน้าเพื่อเพิ่มความรุนแรงของการปะทะ เมื่อชกไปแล้วน้ำหนักตัวของเราจะอยู่ที่เท้าหน้า</p>
                <p>หมัดรงชกตาม เป็นการชกหมัดที่อยู่ด้านหลังของเราตรงไปยังเป้าหมาย อาศัยแรงส่งจากเท้ามายังลำตัวจนถึงหัวไหล่ส่งตรงไปที่หมัดเพื่อปะทะเป้าหมาย เมื่อชกไปแล้วไหล่ ลำตัวและเอวจะบิดคว่ำลง รวมไปถึงสะโพกน้ำหนักตัวจะอยู่ที่เท้าหน้าโดยส่วนใหญ่หมัดตรงชกตามจะมีความหนักหน่วงและรุนแรงสร้างความเสียหายให้กับคู่ต่อสู้มากกว่าหมัดตรงชกนำ</p>
                <h3>ใช้สำหรับ</h3>
                <p>หมัดตรงเป็นการโจมตีที่มักจะพุ่งตรงไปที่เป้าหมายข้างหน้า โดยเฉพาะบริเวณใบหน้ามักเล็งไปที่จมูกหรือคางเพื่อสร้างความเสียหายและทำให้คู่ต่อสู้เสียสมดุล ส่วนลำตัวการชกเฉพาะบริเวณชายโครงหรือลิ้นปี่ทำให้หายใจลำบาก</p>
                
                <h3>ความรุนแรง</h3>
                <p>ความรุนแรงของหมัดนักมวยมืออาชีพสามารถสร้างแรงกระแทกได้สูงมาก โดยมีการประเมินว่าแรงของหมัดนักมวยมืออาชีพสามารถสร้างแรงกระแทกได้ประมาณ 500–1,000 ปอนด์ต่อตารางนิ้ว (PSI) ขึ้นอยู่กับน้ำหนัก ความเร็ว และเทคนิคของนักมวยแต่ละคน</p>
            </div>
    </div>
